...
begin
  ...
  1 : begin
      ...
      begin
         ...
         QteDonnee := (LimitR[getNiveauActuel,Rpoisson]-GetPoisson);
      end;
      SetPoisson(nvRecu);
      yD := 13
      end;
  2:  begin
      ...
      begin
         ...
         QteDonnee := (LimitR[getNiveauActuel,Rbois]-Getbois);
      end;
      SetBois(nvRecu);
      yD := 14
      end;
  3:  begin
      ...
      begin
         ...
         QteDonnee := (LimitR[getNiveauActuel,Routil]-Getoutils);
      end;
      SetOutils(nvRecu);
      yD := 15
      end;
  4:  begin
      ...
      begin
         ...
         QteDonnee := (LimitR[getNiveauActuel,Rlaine]-Getlaine);
      end;
      SetLaine(nvRecu);
      yD := 16
      end;
  5:  begin
      ...
      begin
         ...
         QteDonnee := (LimitR[getNiveauActuel,Rtissu]-Gettissu);
      end;
      SetTissu(nvRecu);
      yD := 17
      end;
