...
Procedure Quitter;           //Procedure Quitter
Procedure Logo;              //Affichage du logo du Jeu
Procedure LogoBDV;           //Affichage du logo de l'Equipe
Procedure LogoBye;           //Affichage du logo Bye
Procedure PressEnter;        //Affichage de "Press Enter"
