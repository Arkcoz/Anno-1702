...
procedure achat_nav_colonisation();        //Achat d'un Navire de Colonisation
procedure achat_nav_exploration();         //Achat d'un Navire d'Exploration
procedure achat_nav_transport();           //Achat d'un Navire de Transport
