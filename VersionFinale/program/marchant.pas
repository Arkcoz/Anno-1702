...
//Procédure pour vendre des outils
procedure vendre_outils();
...
//Procédure pour vendre des poissons
procedure vendre_poissons();
...
//Procédure pour vendre du tissu
procedure vendre_tissu();
...
//Procédure pour vendre de la laine
procedure vendre_laine();
...
//Procedure qui affiche un cadre avertissant le Joueur de la rencontre avec le marchant
procedure Surprise;
begin
  effacerEcran;
...
//Procédure pour acheter des outils
...
//Procédure pour acheter du poisson
procedure acheter_poisson(diffi : Difficultes);
...
//Procédure pour acheter de la laine
procedure acheter_laine(diffi : Difficultes);
...
//Procédure pour acheter du tissu
procedure acheter_tissu(diffi : Difficultes);
...
//Procédure pour acheter du bois
procedure acheter_bois(diffi : Difficultes);
